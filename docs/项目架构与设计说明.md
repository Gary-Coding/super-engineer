...
+ discovery.json
-> plan.json
-> manual: plan.md / auto: workflow-report.md
-> status.json
```
...
+ Git diff
-> review.json
-> manual: review.md / auto: workflow-report.md

plan.json
+ 项目识别出的验证命令
-> verify.json
-> manual: verify.md / auto: workflow-report.md
-> status.json
-> notification
```
...
3. [docs/se命令协议.md](./se命令协议.md)
4. [super-engineer-workflow/references/workflow.md](../super-engineer-workflow/references/workflow.md)
